...
// The CD workflow overrides these with the real commit SHA on every deploy — 'latest' only matters for
// a manual first deployment before any image has been pushed.
